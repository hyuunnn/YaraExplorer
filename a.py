...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_2.setText(_translate("Dialog", "Yara Rule"))
        self.plainTextEdit_2.setPlainText(_translate("Dialog", "import \"hash\"\n"
"import \"pe\"\n"
"\n"
"rule xor_transform\n"
"{\n"
...
"      5 of them\n"
"}"))
        self.label_4.setText(_translate("Dialog", "Path Setting"))
        self.lineEdit_2.setText(_translate("Dialog", "C:\\aaaa\\aaaa\\aaaaaa\\aaaaa\\"))
        self.pushButton.setText(_translate("Dialog", "Start"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.Main), _translate("Dialog", "Main"))
        self.label.setText(_translate("Dialog", "Detected File"))
        self.label_6.setText(_translate("Dialog", "Not Detected File"))
        ...
        item.setText(_translate("Dialog", "rulename"))
        item = self.tableWidget.horizontalHeaderItem(1)
        item.setText(_translate("Dialog", "filename"))
        item = self.tableWidget.horizontalHeaderItem(2)
        item.setText(_translate("Dialog", "filesize"))
        __sortingEnabled = self.tableWidget.isSortingEnabled()
        self.tableWidget.setSortingEnabled(False)
        item = self.tableWidget.item(0, 0)
        item.setText(_translate("Dialog", "rulename1"))
        item = self.tableWidget.item(0, 1)
        item.setText(_translate("Dialog", "filename1"))
        item = self.tableWidget.item(0, 2)
        item.setText(_translate("Dialog", "filesize1"))
        item = self.tableWidget.item(1, 0)
        item.setText(_translate("Dialog", "rulename2"))
        item = self.tableWidget.item(1, 1)
        item.setText(_translate("Dialog", "filename2"))
        item = self.tableWidget.item(1, 2)
        item.setText(_translate("Dialog", "filesize2"))
        item = self.tableWidget.item(2, 0)
        item.setText(_translate("Dialog", "rulename3"))
        item = self.tableWidget.item(2, 1)
        item.setText(_translate("Dialog", "filename3"))
        item = self.tableWidget.item(2, 2)
        item.setText(_translate("Dialog", "filesize3"))
        item = self.tableWidget.item(3, 0)
        item.setText(_translate("Dialog", "rulename4"))
        item = self.tableWidget.item(3, 1)
        item.setText(_translate("Dialog", "filename4"))
        item = self.tableWidget.item(3, 2)
        item.setText(_translate("Dialog", "filesize4"))
        item = self.tableWidget.item(4, 0)
        item.setText(_translate("Dialog", "rulename5"))
        item = self.tableWidget.item(4, 1)
        item.setText(_translate("Dialog", "filename5"))
        item = self.tableWidget.item(4, 2)
        item.setText(_translate("Dialog", "filesize5"))
        item = self.tableWidget.item(5, 0)
        item.setText(_translate("Dialog", "rulename6"))
        item = self.tableWidget.item(5, 1)
        item.setText(_translate("Dialog", "filename6"))
        item = self.tableWidget.item(5, 2)
        item.setText(_translate("Dialog", "filesize6"))
        item = self.tableWidget.item(6, 0)
        item.setText(_translate("Dialog", "rulename7"))
        item = self.tableWidget.item(6, 1)
        item.setText(_translate("Dialog", "filename7"))
        item = self.tableWidget.item(6, 2)
        item.setText(_translate("Dialog", "filesize7"))
        item = self.tableWidget.item(7, 0)
        item.setText(_translate("Dialog", "rulename8"))
        item = self.tableWidget.item(7, 1)
        item.setText(_translate("Dialog", "filename8"))
        item = self.tableWidget.item(7, 2)
        item.setText(_translate("Dialog", "filesize8"))
        item = self.tableWidget.item(8, 0)
        item.setText(_translate("Dialog", "rulename9"))
        item = self.tableWidget.item(8, 1)
        item.setText(_translate("Dialog", "filename9"))
        item = self.tableWidget.item(8, 2)
        item.setText(_translate("Dialog", "filesize9"))
        item = self.tableWidget.item(9, 0)
        item.setText(_translate("Dialog", "rulename10"))
        item = self.tableWidget.item(9, 1)
        item.setText(_translate("Dialog", "filename10"))
        item = self.tableWidget.item(9, 2)
        item.setText(_translate("Dialog", "filesize10"))
        ...
        self.label_3.setText(_translate("Dialog", "Move File"))
        self.lineEdit.setText(_translate("Dialog", "C:\\asdasdasd"))
        self.pushButton_2.setText(_translate("Dialog", "Move"))
        self.label_5.setText(_translate("Dialog", "Move File"))
        self.lineEdit_3.setText(_translate("Dialog", "C:\\asdasdasd"))
        self.pushButton_3.setText(_translate("Dialog", "Move"))
        self.pushButton_4.setText(_translate("Dialog", "Save CSV"))
        self.pushButton_6.setText(_translate("Dialog", "Save CSV"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.YaraExplorer), _translate("Dialog", "YaraExplorer"))
